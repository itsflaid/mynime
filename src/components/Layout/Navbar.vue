<template>
  <header class="sticky top-0 z-50 border-b border-zinc-200 bg-white/90 backdrop-blur-xl">
    <nav class="mx-auto flex h-16 max-w-7xl items-center gap-3 px-4 sm:px-6 lg:px-8">
      ...
      <div class="hidden h-9 w-9 items-center justify-center rounded-full border border-pink-200 bg-pink-50 text-pink-600 md:flex">
...
import { Menu, Plus, Search, UserRound, X } from '@lucide/vue'
